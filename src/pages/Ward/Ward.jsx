      ...
      <main className="flex-1 ml-64 p-6">
          <div className="border-2 rounded-md p-4 w-full max-w-4xl mt-[70px] mx-auto bg-[#F9F9F9] shadow">
            ...
            <div className="bg-[#BDD0F5] text-[#3C3C3C] p-2 rounded-[8px] mb-4">
              Check through your doctor list
            </div>
            ...
            <div className="overflow-auto">
              <table className="w-full border border-gray-300">
                <thead className="bg-gray-100">
                  <tr>
                    <th className="border font-normal px-4 py-2">Username</th>
                    <th className="border font-normal px-4 py-2">Full Name</th>
                    <th className="border font-normal px-4 py-2">Phone Number</th>
                    <th className="border font-normal px-4 py-2">Gender</th>
                    <th className="border font-normal px-4 py-2">Date Added</th>
