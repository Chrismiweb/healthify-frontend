...
//     { name: 'Explore', icon: <Search size={18} />, active: true },
//     { name: 'Profile', icon: <User size={18} /> },
//     { name: 'Ward', icon: <User size={18} /> },
//     { name: 'Sessions', icon: <FileText size={18} /> },
//     { name: 'Nearest hospitals', icon: <Hospital size={18} /> },
//     { name: 'Wellness& Lifestyle', icon: <HeartPulse size={18} /> },
//     { name: 'Finance', icon: <Wallet size={18} /> },
//     { name: 'Manage subscription', icon: <CalendarDays size={18} /> },
//     { name: 'Help/platform feedback', icon: <HelpCircle size={18} /> },
...
//         <div
//           key={index}
//           className={`flex items-center space-x-2 px-3 py-2 rounded-md cursor-pointer hover:bg-blue-100 transition ${
//             item.active ? 'bg-[#4369B2] text-white' : 'text-gray-700'
//           }`}
//         >
//           {item.icon}
